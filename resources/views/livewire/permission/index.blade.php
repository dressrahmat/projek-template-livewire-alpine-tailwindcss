            ...
            <div class="card-body">
                ...
                <div class="flex justify-between items-center mx-4 gap-x-9">
                    <div class="border-l-8 border-accent px-4 py-4 my-2 bg-gray-500 shadow-md">
                        <h1 class="text-xl text-slate-50 font-bold">Data Permission</h1>
                    </div>
                    <div>
                ...
                <table class="table text-base">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a wire:click.prevent="show({{ $role->id }})" class="btn btn-xs btn-primary">Lihat
                                    Detail</a>
                                <a wire:ignore wire:click.prevent="updateAksiId({{ $role->id }})"
                                    class="btn btn-xs btn-success">Edit</a>
                                <a class="btn btn-xs bg-red-300" type="button"
                                    wire:click.defer="delete({{ $role->id }})"
